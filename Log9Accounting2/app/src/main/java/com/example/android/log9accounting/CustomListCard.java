...
class CustomListCard extends BaseAdapter {

    private Context context;
    private ArrayList<String> id, date, amount, description, type, image, card, head, reimburse;

    CustomListCard(Context context,
                      ArrayList<String> id, ArrayList<String> date, ArrayList<String> amount, ArrayList<String> description, ArrayList<String> type, ArrayList<String> image, ArrayList<String> card, ArrayList<String> head, ArrayList<String> reimburse) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_single_card, parent, false);
        ...
        TextView txt_card = rowView.findViewById(R.id.txt_card);
        txt_card.setText(card.get(position));
        ...
        transactionImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, CardImageActivity.class).putExtra("imageUrl", image.get(position));
