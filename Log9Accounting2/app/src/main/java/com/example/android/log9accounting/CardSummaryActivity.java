...
public class CardSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CustomListCard adapter = new
                CustomListCard(CardSummaryActivity.this, id, date, amount, description, type, image, card, head, reimburse);
        listview = findViewById(R.id.list_card_summary);
                    ...
                    if(!year.getKey().equals("Transaction Type")) {
                        ...
                        for(DataSnapshot transactionId: year.getChildren()) {
                            if(!transactionId.getKey().equals("Yearly Counter")) {
                                ...
                                card.add("Card Number: " + transactionId.child("Card Number").getValue());
