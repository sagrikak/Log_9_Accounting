...
public class DisplayCardActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private DatabaseReference dbRef, offsetRef, mReimbursementRef, mEmployeeRef;
    private EditText descriptionCard, amountCard, numberCard, reimburseCard;
    private Spinner spinner;
    private DatePicker datePicker;
    private Calendar c;
    private String radioCard, curYear, dateCard, curMonth, curSession, date, head;

    private StorageReference mStorageRef, imageRef;
    private int addCounterCount, getCounterCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePicker = findViewById(R.id.date_card);
        descriptionCard = findViewById(R.id.et_description);
        amountCard = findViewById(R.id.et_amount);
        numberCard = findViewById(R.id.et_card_number);
        reimburseCard = findViewById(R.id.et_reimbursement);
    ...
    public void onImageButtonClicked(View view) {
        final CharSequence[] items = { "Take Photo", "Choose from Library",
                "Cancel" };
        AlertDialog.Builder builder = new AlertDialog.Builder(DisplayCardActivity.this);
    ...
    public void cameraIntent() {
        int permissionCheck = ContextCompat.checkSelfPermission(DisplayCardActivity.this,
        ...
        if(permissionCheck == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(DisplayCardActivity.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_CAMERA: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(DisplayCardActivity.this, "Camera Permission Granted", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(DisplayCardActivity.this, "Camera Permission Denied. You can't use camera for this task.", Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            ...
            case CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE:
                ...
                if(resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(DisplayCardActivity.this, "Error Occured", Toast.LENGTH_SHORT).show();
                }
                Toast.makeText(DisplayCardActivity.this, "Image selected", Toast.LENGTH_SHORT).show();
                break;
            case REQUEST_CAMERA:
                if (resultCode == RESULT_OK) {
                    Log.d("Image", "clicked");
    ...
    public void onSubmit(View view) {
        ...
        if (TextUtils.isEmpty(descriptionCard.getText().toString()) || TextUtils.isEmpty(amountCard.getText().toString()) || TextUtils.isEmpty(numberCard.getText().toString()) || selectedImage == null) {
    ...
    public void uploadImage(final String imageName) {
        ...
        imageRef = mStorageRef.child("Card/" + curSession + "/" + imageName);
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(DisplayCardActivity.this, "Error in uploading!", Toast.LENGTH_SHORT).show();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(DisplayCardActivity.this, "Image successfully uploaded", Toast.LENGTH_SHORT).show();
                addData(imageName);
            }
        });
    }
    ...
    public void addData(String refIdCard) {
        ...
        dbRef.child(curSession).child(refIdCard).child("Description").setValue(descriptionCard.getText().toString());
        dbRef.child(curSession).child(refIdCard).child("Card Number").setValue(numberCard.getText().toString());
        dbRef.child(curSession).child(refIdCard).child("Amount").setValue(amountCard.getText().toString());
        dbRef.child(curSession).child(refIdCard).child("Type").setValue(radioCard);
        ...
        if (!TextUtils.isEmpty(reimburseCard.getText().toString())) {
            dbRef.child(curSession).child(refIdCard).child("Reimbursement ID").setValue(reimburseCard.getText().toString());

            String reimburse = "";
            for (int i=3; i<reimburseCard.getText().toString().length(); i++){
                reimburse += reimburseCard.getText().toString().charAt(i);
            }
            final String re;
            re = reimburse;

            String reimburseId = reimburseCard.getText().toString();
                        ...
                        mEmployeeRef.child(user_id).child("amount_paid").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                mEmployeeRef.child(user_id).child("amount_paid").setValue(String.valueOf(Integer.valueOf(amount_paid) +
                                        Integer.valueOf(amountCard.getText().toString())));
                            }
