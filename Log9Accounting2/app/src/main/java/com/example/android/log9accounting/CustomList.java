...
class CustomList extends BaseAdapter {
    ...
    private ArrayList<String> id, date, amount, description, type, image, head, reimburse;

    CustomList(Context context,
                      ArrayList<String> id, ArrayList<String> date, ArrayList<String> amount, ArrayList<String> description, ArrayList<String> type, ArrayList<String> image, ArrayList<String> head, ArrayList<String> reimburse) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        transactionImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, CashImageActivity.class).putExtra("imageUrl", image.get(position));
