...
public class CardImageActivity extends AppCompatActivity {
    private String id, date, amount, description, type, url, card, head, reimburse;
    private ImageView transactionImage;
    private TextView txt_id, txt_date, txt_amount, txt_description, txt_type, txt_card, txt_head, txt_reimburse;
    @Override
